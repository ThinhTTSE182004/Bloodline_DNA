...
public partial class BloodlineDnaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CollectionMethodId).HasName("PK__Collecti__1B185E4763AB75C2");
        ...
        {
            entity.HasKey(e => e.DeliveryId).HasName("PK__Delivery__1C5CF4F588F04F15");
        ...
        {
            entity.HasKey(e => e.TaskId).HasName("PK__Delivery__0492148DE21FE2B8");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__7A6B2B8C128C770C");
        ...
        {
            entity.HasKey(e => e.ResponseId).HasName("PK__Feedback__EBECD896B7AC4D35");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__465962296770C485");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__Order_de__3C5A40801FCB098D");
        ...
        {
            entity.HasKey(e => e.ParticipantId).HasName("PK__Particip__4E037806E5AB8558");
        });

        modelBuilder.Entity<Payment>(entity =>
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__ED1FC9EA62E8E3A8");
        ...
        {
            entity.HasKey(e => e.PermissionId).HasName("PK__Permissi__E5331AFA2C01B74F");
        });

        modelBuilder.Entity<Result>(entity =>
        {
            entity.HasKey(e => e.ResultId).HasName("PK__Result__AFB3C31653809516");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__760965CCC563B2F1");
            ...
            entity.HasMany(d => d.Permissions).WithMany(p => p.Roles)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("RoleId", "PermissionId").HasName("PK__Role_Per__C85A546320B27E62");
        ...
        {
            entity.HasKey(e => e.SampleId).HasName("PK__samples__84ACF7BA1744738D");
        ...
        {
            entity.HasKey(e => e.SampleKitId).HasName("PK__Sample_k__0BEC49D5A208A3CB");
        ...
        {
            entity.HasKey(e => e.TransferId).HasName("PK__Sample_t__78E6FD338BF68071");
        ...
        {
            entity.HasKey(e => e.SampleTypeId).HasName("PK__Sample_t__52C648961C636C67");
        });

        modelBuilder.Entity<ServicePackage>(entity =>
        {
            entity.HasKey(e => e.ServicePackageId).HasName("PK__Service___9685932745DA18E7");
        ...
        {
            entity.HasKey(e => e.ServicePriceId).HasName("PK__Service___B715FBB736368C18");
        ...
        {
            entity.HasKey(e => e.TestTypeId).HasName("PK__TestType__9BB8764657E434DC");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__USERS__B9BE370F202F9594");
        ...
        {
            entity.HasKey(e => e.ProfileId).HasName("PK__User_pro__AEBB701F1EB93252");
