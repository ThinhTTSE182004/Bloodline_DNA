...
public partial class BloodlineDnaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CollectionMethodId).HasName("PK__Collecti__1B185E4723A43865");
        ...
        {
            entity.HasKey(e => e.DeliveryId).HasName("PK__Delivery__1C5CF4F523F62DFB");
        ...
        {
            entity.HasKey(e => e.TaskId).HasName("PK__Delivery__0492148DDD493DCC");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__7A6B2B8CD230E60F");
        ...
        {
            entity.HasKey(e => e.ResponseId).HasName("PK__Feedback__EBECD8965D905F4D");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__46596229CFBA94CF");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__Order_de__3C5A4080BCE391A1");
        ...
        {
            entity.HasKey(e => e.ParticipantId).HasName("PK__Particip__4E037806A01DADBE");
        });

        modelBuilder.Entity<Payment>(entity =>
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__ED1FC9EA2A5125A1");
        ...
        {
            entity.HasKey(e => e.PermissionId).HasName("PK__Permissi__E5331AFA3BBAEED7");
        });

        modelBuilder.Entity<Result>(entity =>
        {
            entity.HasKey(e => e.ResultId).HasName("PK__Result__AFB3C3161C9F65E0");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__760965CCE29A8A77");
            ...
            entity.HasMany(d => d.Permissions).WithMany(p => p.Roles)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("RoleId", "PermissionId").HasName("PK__Role_Per__C85A5463255255EA");
        ...
        {
            entity.HasKey(e => e.SampleId).HasName("PK__samples__84ACF7BA864F7D1F");
        ...
        {
            entity.HasKey(e => e.SampleKitId).HasName("PK__Sample_k__0BEC49D50CF36D04");
        ...
        {
            entity.HasKey(e => e.TransferId).HasName("PK__Sample_t__78E6FD3319029573");
        ...
        {
            entity.HasKey(e => e.SampleTypeId).HasName("PK__Sample_t__52C64896896AA250");
        });

        modelBuilder.Entity<ServicePackage>(entity =>
        {
            entity.HasKey(e => e.ServicePackageId).HasName("PK__Service___968593273B96C538");
        ...
        {
            entity.HasKey(e => e.ServicePriceId).HasName("PK__Service___B715FBB76CBC1AB5");
        ...
        {
            entity.HasKey(e => e.TestTypeId).HasName("PK__TestType__9BB876463D264861");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__USERS__B9BE370F48BFD6E3");
        ...
        {
            entity.HasKey(e => e.ProfileId).HasName("PK__User_pro__AEBB701F850CA860");
