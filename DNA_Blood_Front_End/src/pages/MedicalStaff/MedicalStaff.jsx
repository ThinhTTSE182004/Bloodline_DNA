    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1600px] mx-auto">
          <h1 className="text-3xl font-bold text-gray-800 mb-8">Medical Staff Dashboard</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <StatCard icon={<FaTags className="w-8 h-8 text-teal-500"/>} title="Total Samples Assigned" value={stats.totalSamples} color="border-l-4 border-teal-500" />
